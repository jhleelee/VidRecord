...
public class CameraFilterBlend extends CameraFilter {
    ...
    @Override protected int createProgram(Context applicationContext) {
        return GlUtil.createProgram(
                applicationContext,
                R.raw.vertex_shader_two_input,
                R.raw.fragment_shader_ext_blend);
    }

    @Override protected void getGLSLValues() {
        super.getGLSLValues();
        maExtraTextureCoordLoc = GLES20.glGetAttribLocation(mGLProgId, "aExtraTextureCoord");
        muExtraTextureLoc = GLES20.glGetUniformLocation(mGLProgId, "uExtraTexture");
    }
